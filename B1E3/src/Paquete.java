...
public class Paquete { //CREAMOS LA CLASE
    ...
    public void setPrecio(Float precio) {
        if (precio != null && this.calcularPrecioMinimo()<precio) {
    ...
    public String[] getTrayectoActual(){
    ...
    public boolean actualizarTrayectoria(String poblacion){
        ...
        for(int i=0;i<longitud;i++) { //realizamos un for hasta la longitud
            ...
            this.trayectoActual=auxiliar; //actualizamos la trayectoria actual
    ...
    public boolean equals(Object obj) { //metodo equals para paquete
        ...
        final Paquete nuevo = (Paquete) obj;
