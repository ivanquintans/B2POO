...
public interface IActor extends IParticipante{
    ...
    void setCache(float cache) throws ExcepcionActor;
    void setDeseos(ArrayList<String> deseos) throws ExcepcionActor;
     ...
     */
    int importancia(String tipoParticipacion) throws ExcepcionActor;
