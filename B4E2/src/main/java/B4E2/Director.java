...
public class Director implements IDirector {
    ...
    public Director(String nombre, Set<String> especialista,HashMap<String, Float> cache) throws ExcepcionParticipante {

        //gestionamos la excepcion
        if (nombre==null){
            throw new ExcepcionParticipante("No se puede crear el director: el nombre del director no puede ser null",
                    this);
    ...
    public void setNombre(String nombre) {
        //como no se dice nada entiendo que si se produce una excepcion en el setter es diferente a si se produce el el constructor
        if(nombre!=null){
            this.nombre = nombre;
        }
    }
    ...
    public void setEspecialista(Set<String> especialista) throws ExcepcionDirector{

        if(especialista==null){
            throw new ExcepcionDirector("No se pueden modificar el atributo especialista del director "+ this.nombre+ ": la instancia de especialista no puede ser null",
                    this);
        }

        if(especialista.isEmpty()){
            throw new ExcepcionDirector("No se pueden modificar el atributo especialista del director "+ this.nombre+ ": la instancia de especialista es una lista vacia",
                    this);
        }
        ...
        for (String genero : especialista) {
            ...
            if (genero==null || !nombreclases.contains(genero)) {
                throw new ExcepcionDirector("No se pueden modificar el atributo especialista del director"+ this.nombre+ ": alguno de los géneros indicados en la lista no está permitido\"",
                        this);
            }
